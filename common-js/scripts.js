...
(function ($) {
	...
	var countperso = document.getElementsByClassName('countdown');
	//countperso.dataset.remainingSec= "20";
	countperso[0].dataset.remainingSec = Math.round(Date.parse('16 Nov 2020 00:00')/ 1000)-Math.round($.now()/ 1000)
	...
	//Date.parse('16 Nov 2020 00:00')-$.now()
